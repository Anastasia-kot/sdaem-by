        ...
        <div className={styles.objects}>
            ...
            <div className={styles.objects__items}>
                ...
                <div className={isListCatalogue ? styles.ResultListListView : styles.ResultListTileView}>
                    ...
                    {isListCatalogue
                        ? <PaginatedItems itemsPerPage={3} items={data} style={'list'} Component={CatalogueCard} />
                        : <PaginatedItems itemsPerPage={6} items={data} style={'tile'} Component={CatalogueCard} />
                    }
